# Скопируйте готовый код модуля сюда,
# кроме импорта модуля run_screensaver и блока if __name__ main.
...
class Character:
    ...
    def defence(self):
        value_defence = DEFAULT_DEFENCE * radint(*self.RANGE_VALUE_DEFENCE)
